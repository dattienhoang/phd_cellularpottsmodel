...
/*** HAMILTONIAN FUNCTIONS ***/
    ...
    double  ratioEnergy(int);
    double  finalRatioEnergy();
...
/*******************************************************************************/
/****Return the perimeter squared to volume ratio energy *******/

double ratioEnergy (int cell) {
    int perimeter = cellPerimeterList[cell].size();
    int perimeter_sq = perimeter * perimeter;
    
    int area = cellVolumeList[cell].size();
    
    double ratio = ((double) perimeter_sq)/((double) area);
    
    double fourpi = 4 * 3.14159;
    
    return L_rat*(ratio - fourpi)*(ratio - fourpi);
}
...
/*******************************************************************************/
/*** Return the full ratio energy of the lattice ***/

double finalRatioEnergy() {
    double energy = 0.0;
    for (int cell=1; cell<=numCells; cell++){
        energy += ratioEnergy(cell);
    }
    return energy;
}
