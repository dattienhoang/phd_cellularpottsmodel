...
/*** Global Parameters ***/
  ...
  const double J_air =		100.0;
  const double J_cel =		200.0;
  ...
  const double L_blb =		500.0;    		//  penalty for wiggliness
...
*/
  ...
  /* Calculate the initial energy */
    ...
    if(doPrinting){
        ...
        fprintf(efile,"%8.3lf %8.3lf ", totalBlobularEnergy, totalVolumeEnergy);
